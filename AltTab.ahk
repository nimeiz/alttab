...
> https://github.com/nimeiz/alttab
...
Key_Pressed_1st_Letter:
  ...
  Loop, %Window_Found_Count%
    ...
    Else
     ...
     ;MsgBox % List_Title_Text
    StringUpper, List_Title_Text, List_Title_Text ; need to match against upper case when alt is held down
    
    List_Title_Text1:=Asc(List_Title_Text) ; convert to ASCII key code
    if (List_Title_Text1 > 255) {
      List_Title_Text1 := Asc(zh2py(List_Title_Text))
    }
    If Key_Pressed_ASCII =%List_Title_Text1%
      {
      LV_Modify(Selected_Row, "Focus Select")
      Break
      }
